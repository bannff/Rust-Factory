...
V1 uses only the Rust standard library: structs/enums/newtypes, BTreeMap/BTreeSet, explicit validation, typed errors, and SHA-256 only if a stable decision digest needs evidence binding. No auth framework belongs in policy-core.
