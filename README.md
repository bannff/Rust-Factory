...
The durable canonical agent handbook is the Git Wiki revision pinned in [`AGENTS.md`](AGENTS.md): `9985702129a653d1e963edb67236f4c934e4d2c8`, tracked by [#45](https://github.com/bannff/Rust-Factory/issues/45). Clone, detach, and verify that exact revision before relying on handbook guidance. The [Wiki Home](https://github.com/bannff/Rust-Factory/wiki/Home), [Handbook Governance](https://github.com/bannff/Rust-Factory/wiki/Handbook-Governance), and [CI/CD and Validation](https://github.com/bannff/Rust-Factory/wiki/CI-CD-and-Validation) pages are non-authoritative browser navigation unless verified against the pin.
