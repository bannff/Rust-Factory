...
ADAPTER_DEPS := rmcp mcp-transport mcp-contract schemars@0.9.0 schemars@1.2.2 anyhow cap-std tokio genai reqwest futures agentic-memory redb opentelemetry opentelemetry_sdk serdes-ai-evals biscuit-auth prost subprocess
